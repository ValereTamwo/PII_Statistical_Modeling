...
def categorize_all_localstorage(input_file: Path, output_dir: Path, patterns: Dict):
    """
...
def main():
    ...
    output_base_dir = base_dir / 'categorized_localstorage'
    ...
    for user in users:
        ...
        for auth_status in auth_statuses:
            for policy in policies:
                input_dir = base_dir / 'preprocessing' / auth_status / user / policy / 'localstorage'
                if not input_dir.exists():
                    print(f"Le dossier {input_dir} n'existe pas, passage à la configuration suivante.")
                    continue
                output_base_dir = base_dir / 'user' / auth_status / user / policy / 'localstorage'
                ...
                for source_type, input_file, output_dir in files_to_process:
                    if input_file.exists():
                        categorize_all_localstorage(input_file, output_dir, user_patterns)
                    else:
