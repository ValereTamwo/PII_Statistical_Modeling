#!/usr/bin/env python3
"""
MODULE — SCORE DE RISQUE RGPD UNIFIÉ (VERSION À RIGUEUR FORMELLE)
...
mais un outil d’aide à l’audit et à la priorisation RGPD.
...
# =====================================================================
# DIMENSION 1 — SENSIBILITÉ DU CONTENU (0–4)
# =====================================================================
...
def interpret_entropy_in_context(entropy: float, category: str, value: str) -> EntropyAssessment:
    """
    L’entropie ne crée jamais le risque.
    ...
    if category in {
        ...
        if entropy > 4.5:
            return EntropyAssessment(True, "Identifiant ou token à forte entropie")
...
# =====================================================================
# DIMENSION 2 — EXPOSITION TECHNIQUE (0–3)
# =====================================================================
    ...
    if storage_type.lower() == 'cookies':
        ...
        if expires:
            try:
                ...
                # Si déjà expiré au moment de la collecte
                ...
                if days >= 30:
                    return 1, f"Durée 30j–1an ({int(days)} jours)"
...
# =====================================================================
# DIMENSION 4 — CONTEXTE TIERS (0–2)
# =====================================================================
